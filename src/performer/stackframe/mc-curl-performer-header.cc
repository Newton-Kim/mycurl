...
mcCurlPerformerHeader::mcCurlPerformerHeader(mcCurlHeader* header, string mnymonic) : m_header(header), m_mnymonic(mnymonic) {}
...
void mcCurlPerformerHeader::rm(string key){
	m_header->rm(key);
}
