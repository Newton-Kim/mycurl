...
mcCurlPerformerConnection::~mcCurlPerformerConnection() { delete m_curl; }
...
string mcCurlPerformerConnection::mnymonic(void) { return m_curl->mnymonic(); }

void mcCurlPerformerConnection::get(string path) { m_curl->get(path); }

void mcCurlPerformerConnection::del(void) { m_curl->del(); }

void mcCurlPerformerConnection::post(string inpath, bool chunk,
                                     string outpath) {
...
bool mcCurlPerformerConnection::verbose(void) { return m_curl->verbose(); }

void mcCurlPerformerConnection::verbose(bool onoff) { m_curl->verbose(onoff); }

bool mcCurlPerformerConnection::follow(void) { return m_curl->follow(); }

void mcCurlPerformerConnection::follow(bool onoff) { m_curl->follow(onoff); }
